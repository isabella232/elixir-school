...
Functies zijn eersteklas burgers in Elixir en vele andere functionele talen! In deze les zullen we kennis maken met de verschillende soorten functies binnen Elixir, wat ze verschillend maakt en hoe ze te gebruiken.
ges, functions are first class citizens.  We will learn about the types of functions in Elixir, what makes them different, and how to use them.

## Inhoud

- [Anonieme functies](#anonymous-functions)
  - [Het & kortschrift](#the--shorthand)
- [Pattern matching](#pattern-matching)
- [Functies met een naam](#named-functions)
  - [Private functies](#private-functions)
  - [Guards](#guards)
  - [Standaard argumenten](#default-arguments)

## Anonieme functies

Net zoals de naam al aangeeft, heeft een anonieme functie geen naam. We zagen al in de `Enum` les dat ze vaak doorgegeven worden aan andere functies. We gebruiken de `fn` en `end` keywords om een anonieme functie te definiëren in Elixir. Tussen deze keywords kunnen we meerdere parameters en function bodies (onderdeel dat aangeeft wat de functie doet) definiëren, gescheiden door `->`.
